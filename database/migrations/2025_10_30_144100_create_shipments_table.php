...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('shipments', function (Blueprint $table) {
            ...
            $table->foreignId('sender_id')->nullable()->constrained('senders')->onUpdate('cascade');        // id spedizione
            ...
            $table->string('shipment_path');                                                                // percorso cartella file spedizione
            ...
            $table->date('extraction_date');                                                                // data estrazione 
            $table->string('extraction_zip_file');                                                          // nome file estrazione
            $table->timestamps();
        });
    }
